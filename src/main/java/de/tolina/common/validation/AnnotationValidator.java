...
public class AnnotationValidator {
	private HashSet<String> paramBlacklist;
	...
	public static AnnotationValidation validate() {
		...
		return new AnnotationValidator().new AnnotationValidation(paramBlacklist);
	}
	...
	private void checkForUndefinedMethodsInAnnotation(final SoftAssertions softly, final Annotation annotation, final List<String> validatedMethods) {
		...
		for (final Method declaredMethod : allMethods) {
			...
			// there should be no methods in current annotation which are not defined in annotation definition
